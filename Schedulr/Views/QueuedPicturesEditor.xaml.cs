...
{
    /// <summary>
    /// Interaction logic for QueuedPicturesEditor.xaml
    /// </summary>
    public partial class QueuedPicturesEditor : UserControl
    {
        ...
        public static readonly DependencyProperty DetailsPanelVisibleProperty = DependencyProperty.Register("DetailsPanelVisible", typeof(bool), typeof(QueuedPicturesEditor), new UIPropertyMetadata(true, OnDetailsPanelVisibleChanged));

        private static void OnDetailsPanelVisibleChanged(DependencyObject d, DependencyPropertyChangedEventArgs args)
        {
            var editor = (QueuedPicturesEditor)d;
